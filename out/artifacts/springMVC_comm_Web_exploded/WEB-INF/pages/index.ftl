    ...
    <head>
        ...
        <style type="text/css">
            ...
            .top {
                width: 100%;
                height: 77px;
                background-image: url("${contextPath}/images/top.jpg");
            }
            ...
            * {
            ...
            #bg {
                background-image: url(${contextPath}/images/content/dotted.png);
            }
            ...
            .line {
                height: 2px;
                width: 100%;
                background-image: url(${contextPath}/images/left/line_bg.png);
            ...
            .system_log dt {
                background-image: url(${contextPath}/images/left/system.png)
            }

            .custom dt {
                background-image: url(${contextPath}/images/left/custom.png)
            }

            .channel dt {
                background-image: url(${contextPath}/images/left/channel.png)
            }

            .app dt {
                background-image: url(${contextPath}/images/left/app.png)
            }

            .cloud dt {
                background-image: url(${contextPath}/images/left/cloud.png)
            }

            .syetem_management dt {
                background-image: url(${contextPath}/images/left/syetem_management.png)
            }

            .source dt {
                background-image: url(${contextPath}/images/left/source.png)
            }

            .statistics dt {
                background-image: url(${contextPath}/images/left/statistics.png)
            }
...
<div>
    <div class="leftsidebar_box">
        <dl class="system_log">
            <dt>系统管理${contextPath}<img src="images/left/select_xl01.png"></dt>
            <#list activeUser.menus as menu>
                <dd><a target="mainFrame" href="${contextPath}/${menu.url}">${menu.permission}</a></dd>
            </#list>
        </dl>
