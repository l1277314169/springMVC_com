    ...
    <table class="table_white_bg">
        <tbody>
            <tr>
            	  ...
            	  <td class="td_control">
            	  	<input type="text" id="groupName" class="input-medium" style="margin-top:10px;" name="groupName">
        	  	  </td>
        	</tr>
        	<tr>
             ...
             <tr>
            	  ...
            	  <td class="td_control">
						<input id="distributor" type="text" name="distributor" class="input-medium" value="${distributor!''}"  readonly onclick="showMenu(this.id);"/>  
					     ...
					     <#include "/widgets/jingxiaos_widget.ftl" />            	  </td>
            </tr>
             <tr>
...
<div id="menuContent_cl" class="menuContent" style="display: none; position: absolute;">
	<ul id="treeDemo_channel_add" class="ztree" style="margin-top: 10; width: 160px;">
	</ul>
</div>

<div id="menuContent_st" class="menuContent" style="display: none; position: absolute;">
	<ul id="treeDemo_chain_add" class="ztree" style="margin-top: 10; width: 160px;">
	</ul>
</div>

<div id="menuContent_distributor" class="menuContent" style="display: none; position: absolute;">
	<ul id="treeDemo_distributor_add" class="ztree" style="margin-top: 10; width: 160px;">
	</ul>
</div>
...
$("#savetButton").bind("click",function(){
	...
	$.ajax({
	url : "${contextPath}/skuPrice/addSkuPrice",
	type : "post",
	dataType:"json",
	async: false,
...
$('#skuId').click(function(){
	var url = "${contextPath}/skuPrice/showSkuPriceRelationDialog?addSkuPrice="+"addSkuPrice";
   ...
   var setting_category = {
     ...
     function beforeClick(treeId, treeNode) {
        ...
        }else if (zTree.isSelectedNode(treeNode)) {
...
$(document).ready(function () {
        ...
        $.fn.zTree.init($("#treeDemo_chain_add"), setting_st);
        $.fn.zTree.init($("#treeDemo_distributor_add"), setting_distributor);
  });
