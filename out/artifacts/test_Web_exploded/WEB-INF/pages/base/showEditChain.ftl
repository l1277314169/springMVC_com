...
<form id="dataForm" method="post">
		...
		<input type="hidden"  id="chainId" name="chainId" value="${chain.chainId}">
        <table class="table_white_bg" >
            <tbody>
            	<tr>
                	<td class="td_label" ><i class="cc1">*</i>连锁名称：</td>
                    <td class="td_control"><input type="text" name="chainName" required=true  value="${chain.chainName!''}"></td>
                 </tr> 
                 <tr>
               		 <td class="td_label"><i class="cc1">*</i>当前层级：</td>
                     <td class="td_control">
	                    <input type="text" id="superior" name="grade"  required="true" value="${chain.grade}">
                    </td> 
                 </tr>
                 <tr id="tpd">
                 <td  class="td_label" >上级连锁：</td>
                    <td class="td_control">
                    	<input type="text" id="ditch" name="parentId" value="${chain.parentId}" >
                    </td>
                </tr> 
                 <tr>
                	<td  class="td_label"><i class="cc1">*</i>所属渠道：</td>
                	 <td class="td_control">
	                    <input type="text" id="clientStructureId" name="clientStructureId"  class="input-medium" value="${chain.channelId!''}"  readonly onclick="showMenu();" required=true>
                ...
                <tr>
                    ...
                    <td class="td_control">
                    	<input type="text" name="chainNameEn" value="${chain.chainNameEn!''}">
                    </td>
                </tr>
                <tr>
...
$("#savetButton").bind("click",function(){
	...
	$.ajax({
		url : "${contextPath}/chain/updateChain",
		type : "post",
		dataType:"json",
		async: false,
