		...
		<div id="content"> 
			<div id="content-header">
				<div id="breadcrumb"> 
					...
					<a href="#">基础数据管理</a>
					<a class="linkPage active" href="${contextPath}/skuDistribution/showEditSkuDistribution">编辑产品分销</a>
				</div>
		 	</div>
 
<form id="dataForm" method="post" >
		<input type="hidden" name="clientId" value="${clientId}">
		<input type="hidden" id="skuDistributionId" name="skuDistributionId" value="${skuDistribution.skuDistributionId}">
        <table class="table_white_bg">
            <tbody>
            	<tr>
            	<td class="td_label"><i class="cc1">*</i>分组名称：</td>
	            	  <td  class="td_control">
		            	<input id="groupName"  type="text" name="groupName" class="input-medium" value="${skuDistribution.groupName!''}"/><span id="exist" style="display:none;color:red;padding-left: 10;width:100px;">分组名称已存在!</span>
		              </td>
	              </tr>
	              <tr>
	            	  <td class="td_label"><i class="cc1">*</i>渠道：</td>
	            	  <td  class="td_control">
		            	<input id="channel"  type="text" name="channel" class="input-medium"   readonly onclick="showMenu(this.id);"/> 
	              ...
	              <tr>
	            	  ...
	            	  <td  class="td_control">
		            	 <input id="chain" type="text" name="chain" class="input-medium"   readonly onclick="showMenu(this.id);"/>
            	  ...
            	  <tr>
	            	  ...
	            	  <td  class="td_control">
		            	 <input id="distributor" type="text" name="distributor" class="input-medium"   readonly onclick="showMenu(this.id);"/>
	        ...
	        <div id="menuContent_cl" class="menuContent" style="display: none; position: absolute;">
				<ul id="treeDemo_channel_edit" class="ztree" style="margin-top: 0; width: 160px;">
				</ul>
			</div>
			<div id="menuContent_ch" class="menuContent" style="display: none; position: absolute;">
				<ul id="treeDemo_chain_edit" class="ztree" style="margin-top: 0; width: 160px;">
				</ul>
			</div>
			<div id="menuContent_db" class="menuContent" style="display: none; position: absolute;">
				<ul id="treeDemo_distributor_edit" class="ztree" style="margin-top: 0; width: 160px;">
				</ul>
			</div>
        <input type="hidden" id="channelId" name="channelId" value="${skuDistribution.channelId!''}">
        <input type="hidden" id="chainId" name="chainId" value="${skuDistribution.chainId!''}">
        <input type="hidden" id="distributorId" name="distributorId" value="${skuDistribution.distributorId!''}">
        <input type="hidden" id="skuIds" name="skuIds" value="${skuIds}">
        <input type="hidden" id="oldSkuIds" name="oldSkuIds" value="${skuIds}">
</form>
</div>
		<#include "/footer.ftl" />
</body>
...
$(document).ready(function(){
	$.fn.zTree.init($("#treeDemo_distributor_edit"), setting_db);
	$.fn.zTree.init($("#treeDemo_channel_edit"), setting_cl);
	$.fn.zTree.init($("#treeDemo_chain_edit"), setting_ch);
	//分组的唯一性
	...
	$("#savetButton").die().live("click",function(){
		...
		$.ajax({
		url : "${contextPath}/skuDistribution/editSkuDistribution",
		type : "post",
		dataType:"json",
		async: false,
	...
	$('#skuId').click(function(){
		var skuDistributionId = $('#skuDistributionId').val();
		var url = "${contextPath}/skuDistribution/showRelationDialog?skuDistributionId="+skuDistributionId;
