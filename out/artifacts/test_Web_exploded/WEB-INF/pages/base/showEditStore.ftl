            ...
            <tbody>
            	<tr>
                    ...
                    <td id="storeNos" class="td_control">
                    	<input id="storeNo" name="storeNo" type="text" value="${store.storeNo}"/>
                    </td>
                	<td class="td_label" ><i class="cc1">*</i>门店名称：</td>
                    <td class="td_control"><input type="text" name="storeName" required=true value="${store.storeName}"></td>
                </tr> 
                <tr>
                	<td class="td_label">门店自编号：</td>
                	<td class="td_control"><input type="text" name="externalNo" value="${store.externalNo}"/></td>
                	<td class="td_label"><i class="cc1">*</i>所属渠道：</td>
                    <td class="td_control">
                    	<input id="channelName" readonly name="channelName" type="text" required=true value="${store.channelName}"/>
                    </td>
                </tr>
                <tr>
                	<td class="td_label" ><i class="cc1">*</i>所属部门：</td> 
                    <td class="td_control">
	                    <input id="structureName" required="required" readonly name="structureName" type="text" value="${store.structureName}"/>
					</td>
					<td class="td_label">门店状态：
                	</td>
                    <td class="td_control">
	                    <input type="text" class="input-medium" autocomplete="off" id="status" name="status" value="${store.status}"/>
                    </td>
                </tr>
                <tr>
                	<td class="td_label"><i class="cc1">*</i>店铺渠道：</td>
                    <td class="td_control">
                    	<input id="chainName" name="chainName" readonly type="text" required=true value="${store.chainName}"/>
                    </td>
                	<td class="td_label">管理渠道：</td>
                    <td  class="td_control">
	                    <input id="storeType" name="storeType" type="text" value="${store.storeType}"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="td_control">
                    <input id="distributorName" name="distributorName" required=true readonly type="text" value="${store.distributorName}"/>
                    </td>
                	<td class="td_label">门店分组：
                	</td>
                    <td class="td_control">
                    	<input type="text" id="storeGroupId" name="storeGroupId" value="${store.storeGroupId}"/>
                    </td>
                </tr>
                <tr>
                	<td class="td_label">联系人：
                	</td>
                    <td  class="td_control"><input type="text" name="contact" value="${store.contact}">
                    </td>
                	 <td class="td_label"><i class="cc1">*</i>省份：</td>
                	<td class="td_control">
                		<input type="text" id="provinceId" name="provinceId" value="${store.provinceId}"/>
                    </td>
                </tr>
                <tr>
				</tr>
                <tr>
                    ...
                    <td class="td_control"><input type="text" name="mobileNo" isPhone="true" value="${store.mobileNo}">
                    <div id="mobileNoErro"></div>
                    </td>
                    <td class="td_label"><i class="cc1">*</i>城市：</td>
                	<td class="td_control">
                	 	<input type="text" id="cityId" name="cityId" required value="${store.cityId}"/>
                    </td>
                </tr> 
                <tr>
                    ...
                    <td class="td_control">
                    	<input id="fax" name="fax" type="text" value="${store.fax}"/>
                    </td>
                    <td class="td_label">区县：
                	</td>
                    <td class="td_control">
               	 		<input type="text" id="districtId" name="districtId" value="${store.districtId}"/>
                    </td>
                </tr> 
                <tr>
                    ...
                    <td class="td_control">
                    <input id="telephoneNo" name="telephoneNo" type="text" value="${store.telephoneNo}"/>
                    </td>
                </tr>
                <tr>
                	<td class="td_label"><i class="cc1">*</i>地址：</td>
                    <td colspan="3" class="td_control">
                    	<input type="text" name="addr" style="width:450" required=true value="${store.addr}">
                    </td>
                </tr>
                <tr>
	                <td class="td_label">业务员：</td>
	                <td colspan="3" class="td_control">
	                	<input type="text" id="businessman" name="businessman" value="" value="${store.businessman}">
	                </td>
                </tr>
				<tr>
                    <td class="td_label">备注：</td>
                    <td colspan="3" class="td_control">
                    	<textarea maxlength="300" name="remark" placeholder="不超过200个字">${store.remark}</textarea>
                    </td>
                </tr>
                <tr>
