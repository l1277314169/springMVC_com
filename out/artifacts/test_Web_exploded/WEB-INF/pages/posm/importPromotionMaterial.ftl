			...
			<div>
				<table width="100%" border="0" style="font-size:12px">
					<tr>
						...
						<a href="${contextPath}/download/import_template/${clientId}/material_template.xlsx" target="_self" style="text-decoration:none;color:#fff;">
								<span
					...
					<tr>
						...
						<td width="80%">请先下载物料导入模板，仔细阅读表头文字说明。请严格按照表头说明填入内容，以确保导入顺利完成。</td>
					</tr>
					<tr>
            ...
            $("#uploadForm").resetForm().validate({  
                ...
                jQuery("body").showLoading();
                    $("#uploadForm").ajaxSubmit({  
                        url:"${contextPath}/promotionMaterial/import",  
                        type:"post",  
