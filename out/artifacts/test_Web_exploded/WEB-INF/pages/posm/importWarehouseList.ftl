			...
			<div>
				<table width="100%" border="0" style="font-size:12px;background-color:white;">
					<tr>
						...
						<a href="${contextPath}/download/import_template/${clientId}/warehouse_template.xlsx" target="_self" style="text-decoration:none;color:#fff;">
								<span
            ...
            $("#uploadForm").resetForm().validate({  
                ...
                submitHandler: function() {  
                    $("#uploadForm").ajaxSubmit({  
                        url:"${contextPath}/warehouse/mixImport",  
                        type:"post",  
