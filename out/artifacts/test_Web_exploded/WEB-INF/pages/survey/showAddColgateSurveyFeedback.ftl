...
<script type="text/javascript">
	...
	function addSurveyFeedBack(){
		...
		parent.document.location.href = "${contextPath}/survey/addColgateSurveyFeedback?surveyId="+surveyId+"&feedbackDate="+feedbackDate+"&storeNo="+storeNo+"&visitor="+visitor;		
...
$("#storeNo").select2({
		...
		allowClear : true,
		ajax: {
			url: "${contextPath}/store/getUserMappingStoreList",
			dataType: 'json',
			quietMillis: 250,
