...
public class Watermark {
	...
	static {
		...
		if (osName.contains("win")) {
			...
			imageMagickPath = PropertiesHelper.getInstance().getProperty(PropertiesHelper.IMAGEMAGICKPATH);;
		}
	 ...
	 */
	public void WatermarkImg(String srcPath, String distPath,String watermarkImg, int position, int x, int y, int alpha)throws Exception {
	 ...
	 * @throws IM4JavaException
	 */
	private synchronized void watermarkImg(String srcPath, String distPath,String watermarkImg, int width, int height, int x, int y, int alpha)
			throws Exception {
	...
	public static void main(String[] args) throws Exception {
		String src="D://1.jpg";  //需要加水印的源图片  
        String desc="D://22.jpg"; //生成的水印图片的路径  
...
//        watermark.converFontToImage("中华人们", fontType, fontSize, colorStr, water);  
        ...
        watermark.WatermarkImg(src, desc, water, 9, 20,20, 100);
	}
