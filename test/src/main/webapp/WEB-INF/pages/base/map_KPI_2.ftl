	...
	<div class="div_main_map" style="width:400px;height:400px;">
		<div class="div_main_map_title">必备单品覆盖率</div>
		<div id="l-map2"></div>
	</div>
	
    <script type="text/javascript">
    var map2 = new BMap.Map("l-map2", {});                        // 创建Map实例
    map2.centerAndZoom(new BMap.Point(121.523975,31.311873),9);     // 初始化地图,设置中心点坐标和地图级别
	...
	function getBoundary2(){     
		...
		bdary.get("浦东新区", function(rs){       //获取行政区域
			...
			for(var i = 0; i < count; i++){
				var ply = new BMap.Polygon(rs.boundaries[i], {strokeWeight: 2, strokeColor: "#ff0000",fillColor: "#4BB94F"}); //建立多边形覆盖物
