        ...
        <table class="table_white_bg">
            <tbody >
                ...
                <tr>	
                    ...
                    <td class="td_control">
                    	<input type="text" name="brandName" required=true />
                    </td>
				...
				<tr>
                    ...
                    <td class="td_control" colspan="3" valign="middle">
                    	<textarea rows=2  maxlength="300" name="remark"></textarea>
                    </td>
                </tr>
                <tr>
...
$(document).ready(function() {
	...
	$("#parentBrand").hide();
	$("#parentBrand1").hide();
	var addBrandData = [{ id: 1, text: '一级品牌' }, { id: 2, text: '二级品牌' }];
	$("#grade").select2({
				width:145,
				placeholder: "请选择",
				allowClear: true,
	...
	$.ajax({
		url : "${contextPath}/brand/addBrand",
		type : "post",
		dataType:"json",
		async: false,
