					...
					<tr>
						<td colspan="2">
							<div align="left" style="margin:20px">
								<a href="${contextPath}/download/import_template/${clientId}/import_surveyStoreDisplay.xlsx" target="_self" style="text-decoration:none;color:#fff;">
									<span
    ...
    $("#uploadForm").resetForm().validate({  
        submitHandler: function() {  
            ...
            $("#uploadForm").ajaxSubmit({  
                url:"${contextPath}/surveyStoreDisplay/import",  
                type:"post",  
