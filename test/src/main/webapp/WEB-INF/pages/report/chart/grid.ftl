...
<script type="text/javascript">
	...
	jQuery(document).ready(function(e) {
		...
		jQuery("td[name='drill_td']")  .live('click', function() {
			...
			var foreignNamex = jQuery(this).attr("foreignNamex");
			if(null!=foreignNamex && ''!=foreignNamex){
				var argNamex = jQuery(this).attr("argNamex");
				var h2Val = jQuery(this).parents("tbody").find("#"+foreignNamex).html();
				params+=("&"+foreignNamex+"="+jQuery.trim(h2Val)+"&foreignNamex="+foreignNamex+"&argNamex="+argNamex);
			}
