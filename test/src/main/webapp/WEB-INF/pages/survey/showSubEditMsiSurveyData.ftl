		...
		<form class="form-horizontal" action="#" id="dataForm" method="post">
			...
			<div class="control-group">
				...
				<div nowrap="true" class="fl">
					...
					<label class="control-read"><#if store.storeName?length gt 15>${store.storeName?substring(0,15)}…<#else>${store.storeName}</#if></label>
				</div>
				<div nowrap="true" class="fl">
					<label class="control-label">分数：</label>
					<label class="control-point"><#if msiSurveyFeedback.score??>${msiSurveyFeedback.score!''}<#else>0</#if></label>
				</div>
			</div>
			<div class="control-group">
				<div nowrap="true" class="fl">
			...
			<div class="control-group">
				...
				<div nowrap="true" class="fl">
					...
					<div class="controls">
						<input type="text" id="promoter" name="promoter" class="input-medium required" readonly="readonly" style="background-color:#F5F5F5" value="${msiSurveyFeedback.promoter}"/>
					</div>
				</div>
				<div nowrap="true" class="fl">
					<label class="control-label fl" for="promoterNo">促销员工号：</label>
					<div class="controls">
						<input type="text" id="promoterNo" name="promoterNo" class="input-medium required" readonly="readonly" style="background-color:#F5F5F5" value="${msiSurveyFeedback.promoterNo}"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				<div nowrap="true" class="fl">
					...
					<div class="controls">
						<input type="checkbox" id="onDuty" name="onDuty" class="input-medium" value="1" <#if msiSurveyFeedback??&&msiSurveyFeedback.onDuty == '1'>checked="checked"</#if> />
