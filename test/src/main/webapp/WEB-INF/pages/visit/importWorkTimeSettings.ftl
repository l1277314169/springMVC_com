...
<form id="uploadForm" action="" method="post"
		...
		<div>
			<div>
				<table width="100%" border="0" style="font-size:12px;background-color:white;">
					<tr>
						<td colspan="2"><div align="left" style="margin:20px">
						<a href="${contextPath}/download/import_template/${clientId}/${fileName}" style="text-decoration:none;color:#fff;">
								<span
					...
					<tr>
						...
						<td width="80%">请先下载排班导入模板，仔细阅读表头文字说明。请严格按照表头说明填入内容，以确保导入顺利完成。</td>
					</tr>
					<tr>
            ...
            $("#uploadForm").resetForm().validate({  
                ...
                jQuery("body").showLoading();
                    $("#uploadForm").ajaxSubmit({  
                        url:"${contextPath}/workTimeSettings/import",  
                        type:"post",  
                        enctype:"multipart/form-data",  
