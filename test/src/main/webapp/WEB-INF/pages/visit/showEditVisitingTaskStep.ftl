    ...
    $(document).ready(function () {
		...
		//绑定删除按钮
     	$(".delete_span").die().live('click',function(){
     		...
     		var str2 = "visitingTaskSteps[${step}].visitingParameters["+index+"].visitingParameterId";
     		$(this).parents("tr").remove();
     		var visitingParameterIdObj = $("input[name ^='"+str2+"'");
     		$("input[name ^='"+str+"']").remove();    	
     		$("#dataForm").append(visitingParameterIdObj);
     		$("#dataForm").append("<input type='hidden' name='visitingTaskSteps[${step}].visitingParameters["+index+"].isDelete' value='1' />");		
		});
