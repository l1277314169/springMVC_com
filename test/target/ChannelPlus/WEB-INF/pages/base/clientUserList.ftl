			...
			<form class="form-horizontal" action="#" id="searchForm" novalidate="novalidate">
				<div class="control-group">
					<div nowrap="true" class="fl">
						<label class="control-label fl" for="structureName">所属部门：</label>
						<div class="controls">
							<input id="structureName" class="input-medium" name="structureName" value="${structureName}" type="text" readonly/>
						</div>
					</div>
					<div nowrap="true" class="fl">
						<label class="control-label fl" for="clientPositionId">职位：</label>
						<div class="controls">
							<input type="text" id="clientPositionId" name="clientPositionId" class="input-medium" value="${clientPositionId}"/>
						</div>
					</div>
					<div nowrap="true" class="fl">
						<label class="control-label fl" for="parentId">直属上级：</label>
						<div class="controls">
							<input type="text" id="parentId" name="parentId" class="input-medium" value="${parentId}"/>
						</div>
					</div>
					<div nowrap="true" class="fl">
						<label class="control-label fl" for="name">姓名：</label>
						<div class="controls">
							<input type="text" id="name" class="input-medium" name="name" value="${name!''}">
						</div>
					</div>
					<div nowrap="true" class="fl">
						<label class="control-label fl" for="loginName">用户名：</label>
						<div class="controls">
							<input type="text" class="input-medium" name="loginName"  value="${loginName!''}">
						</div>
					</div>
					<div nowrap="true" class="fl">
						<label class="control-label fl" for="isActivation">账号状态：</label>
						<div class="controls">
		                   <input type="text" id="isActivation" name="isActivation" class="input-medium" value="${isActivation}"/>
						</div>
					</div>
					<div nowrap="true" class="fl">
						<label class="control-label fl" for="status">在职状态：</label>
						<div class="controls">
		                   <input type="text" id="status" name="status" class="input-medium" value="${status}"/>
						</div>
					</div>
					<div nowrap="true" class="fl">
						<label class="control-label fl" for="rolesId">角色：</label>
						<div class="controls">
							<input type="text" id="rolesId" name="rolesId" class="input-medium" value="${rolesId}"/>
						</div>
					</div>
					<div nowrap="true" class="fl">
						<label class="control-label fl" for="theLower">查看下级：</label>
						<div class="controls">
							<input type="checkbox" id="theLower" value="" class="input-medium" />
						</div>
					</div>
				</div>
