					...
					<tr>
						<td colspan="2">
							<div align="left" style="margin:20px">
								<a href="${contextPath}/download/import_template/${clientId}/contract_import_template2.xlsx" target="_self" style="text-decoration:none;color:#fff;">
									<span
...
$(function() { 
            $("#uploadForm").resetForm().validate({  
                submitHandler: function() {
                	...
                	var status="${status}";
                	var url = "${contextPath}/contract/import";  
