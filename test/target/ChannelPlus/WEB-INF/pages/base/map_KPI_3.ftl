	<div class="div_main_map" style="width:400px;height:400px;">
		<div class="div_main_map_title">主货架份额</div>
		<div id="l-map3"></div>
	</div>
	
    <script type="text/javascript">
    var map3 = new BMap.Map("l-map3", {});                        // 创建Map实例
    map3.centerAndZoom(new BMap.Point(121.523975,31.311873),9);     // 初始化地图,设置中心点坐标和地图级别
    map3.enableScrollWheelZoom();                        //启用滚轮放大缩小
	
	function getBoundary3(){     
		map3.clearOverlays(); //清除地图覆盖物      
