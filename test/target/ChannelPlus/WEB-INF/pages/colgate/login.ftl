						...
						<tr>
							<td>
								...
								<div class="ctlLoginContent">
										<form id="loginForm" action="${contextPath}/colgate/login" method="post" class="form-horizontal">
									<table width="100%" border="0" cellpadding="3" cellspacing="0">
										<tbody>
											<tr style="display: none;
">
												<td colspan="2">
														<input type="text" class="input-client" id="clientName" name="clientName" value="高露洁" required/>
													<!-- 
														<input type="text" class="input-client" placeholder="客户名称" id="clientName" name="clientName" value="${clientName}" required/>
													-->
														<input type="text" class="input-client" id="loginType" name="loginType" value="/colgate/home/" required/>
														<input type="text" class="input-client" id="onLoginType" name="onLoginType" value="/colgate/login"/>
        ...
        <tr><td></td><td><span id="CtlLogin1_RequiredFieldValidator2" class="ReqValidationMsg" style="color:Red;display:none;">Required</span>&nbsp;</td></tr>
            ...
            <td>
				<div id="retText" style="color:#EF382B;font-size:12px;"></div>
            </td>
