        ...
        <div class="login_content">
			<div class="login_bg">
				<div style="padding:17px 16px 17px 20px;">
					<div class="fl"><img src="${contextPath}/img/ferrero_right.png" height="426" width="494"><!-- 此处的图片可更换 --></div>
					<div class="fl" style="margin-left:20px;width:280px;">
						<div style="margin-top:25px;margin-bottom:5px;height:45px;line-height:45px;vertical-align:middle;"><img src="${contextPath}/img/ferrero_new_logo.png" height="41" style="vertical-align:middle;margin-top:-5px;margin-bottom:5px;"></div>
						<form id="loginForm" action="${contextPath}/login" method="post" class="form-horizontal">
							<input type="hidden"id="clientName" name="clientName" value="费列罗">
							...
							<div class="login-form-group">
									<button class="btn-login" style="background-color:#43d217;border:none;" onclick="saveUserInfo()"> 登 录 </button>
							</div>
