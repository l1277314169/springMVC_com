    <div id="main_bar_${parts.partId}" dataId = "${parts.partId}" style="height:250px;border:1px solid #ccc;padding:10px;margin:10px;padding-top:20px;"></div>
    <script type="text/javascript">
            var barChart = echarts.init(document.getElementById('main_bar_${parts.partId}'));
