        ...
        $(document).ready(function () {
        	...
        	function exportExcel(){
        		if(checekDim()){
					...
					jQuery('#searchForm').attr("action","${contextPath}/report/queryColgate/${baseReport.reportId}");
        		}
			}
			
			function checekDim(){
				var flag = true;
				var dim1 = $("#arg_dim1").val();
				var dim2 = $("#arg_dim2").val();
				var dim3 = $("#arg_dim3").val();
				if(""!=dim1 && ""!=dim2 && ""!=dim3){
...
<form id="searchForm" name="searchForm" action="${contextPath}/report/queryColgate/${baseReport.reportId}" method="POST" >
                    ...
                    <div class="reportFilter">
                         <div>
                            ...
                            <div style="float:right;">
                                <a targer="_self" href="${contextPath}/colgate/reports">
                        ...
                        <div id="filterContent" style="display: block;">
                                    ...
                                    <tbody>
                                        ...
                                        <#list baseReport.reportFilterList as fls>
                                        	...
                                        	<#else>
	                                        	...
	                                        	<#elseif fls.type == 59>
	                                        		<#include "/report/widget/arg_account_widget3.ftl" />
	                                        	<#elseif fls.type == 9>
	                                        		<#include "/report/widget/arg_channel_id_widget2.ftl" />
	                                        	<#elseif fls.type == 24>
	                                        		<#include "/report/widget/arg_chain_id_widget2.ftl" />
	                                        	<#elseif fls.type == 11>
	                                        		<#include "/report/widget/arg_month_widget2.ftl" />
	                                        	<#elseif fls.type == 1>
	                                        		<#include "/report/widget/regions.ftl" />
	                                        	<#else>
                            ...
                            <div style="text-align:right;">
                                ...
                                <#if baseReport.reportId!=59 && baseReport.reportId!=60>
